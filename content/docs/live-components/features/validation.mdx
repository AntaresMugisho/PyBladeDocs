...
<Callout type="warn" title={"The `validators()` method doesn't validate on data updates"}>
...
<Callout type="warn" title={"Don't conflict with PyBlade Live's mechanisms"}>
...
Form classes are a useful abstraction for most larger datasets and a variety of additional features that make them even more powerful. For more information, check out the comprehensive [form objects documentation](/docs/live/forms#extracting-a-form-object).
