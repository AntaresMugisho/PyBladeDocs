...
You can learn more about PyBlade installation and configuration  as well as project initialization in the [Getting started](/docs/getting-started) section of PyBlade documentation.
</Callout>
...
But if you have an old Django project and would like to use PyBlade Template Engine, please check our [Migration guide](/docs/migration-guide).
</Callout>
