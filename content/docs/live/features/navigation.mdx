...
<Callout type="warn" title={"Prefetching on hover increases server usage"}>
...
Read more in the [`pb-current` documentation](/docs/live/live-directives#pb-current).
...
<Callout type="warn" title={"Event listeners will persist across pages"}>
...
<Callout type="info" title={"Head assets are blocking"}>
...
<Callout type="warn" title={"Only query string changes are tracked"}>
